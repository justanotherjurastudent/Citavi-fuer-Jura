...
- Die Anleitungen zu den Gesetzen, Parlamentsdrucksachen, Gerichtsentscheidungen und Interdokumenten wurden aktualisiert.

---

### Version 2.0.1
- Die Ausgabe von Fußnoten- und Literaturverzeichniseinträgen für Gesetzeskommentare mit Sachtiteln wurde verbessert.
- Die Großkommentare zum HGB von Staub („Großkomm. HGB“) sowie zum AktG („Großkomm. AktG“) wurden zur Liste der Sachtitel hinzugefügt.

---

### Version 2.0.2
- Für Gerichtsentscheidungen des EGMR wurde die doppelte Ausgabe des „vol.“ bei der Fundstelle „jugdements“ entfernt.

---

### Version 2.0.3
- Ebd. + Seitenausgabe bei unmittelbarer Wiederholung, aber nicht identischer Zitatseite bei Gerichtsentscheidungen hinzugefügt.
...
- Bessere Handhabung von Ersetzungen:
  - Bei Urteilen werden nun Zeichenketten wie „Kammer“ und „Senat“ aus dem Titel beim Zitieren entfernt.
  - „Urteil“ und „Beschluss“ in der „Art der Entscheidung“ werden nun durch Komponentenfilter zu „Urt.“ und „Beschl.“ abgekürzt.
  - Vorher war diese Ersetzung in den Zitationseigenschaften angelegt, was dazu führte, dass egal wo diese Zeichenketten abgekürzt wurden.

---

### Version 2.1.1
- Paralleltitel nun auch bei Monographien als Diss.
- Wenn eine Monographie zugleich eine Diss. ist und das Werk einen Paralleltitel enthält, wird das zit. als auch ans Ende des LV-Eintrags gesetzt.

---

### Version 2.1.2
- Namensabkürzung bei Uneindeutigkeit hinzugefügt:
  - Wenn mehr als zwei zitierte Autoren denselben Nachnamen haben, wird der Vorname abgekürzt davor ausgegeben, sodass die Ungenauigkeit vermieden wird.
...
### Version 2.2.1
- Abkürzungen der Autoren in Fußnoten nun einheitlich:
  - Ab dem dritten Autor/Herausgeber/Begründer wird nur der erste genannt und dann „u. a.“ angefügt.
  - Dies wurde parallel auch in den Zitierangaben im LV umgesetzt.
- Absturzproblem gelöst durch neue Komponentenprogrammierung:
  - Bei leerem Paralleltitel oder übl. Abkürzung wird dieser durch den Titel ersetzt (nur in den Zitierangaben am Ende eines LV-Eintrags).
